...
import { Edit2, Save, X, Download, ImageIcon, Upload, Trash2, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap gap-4 items-center">
            <Link href="/admin" className="flex items-center gap-2 bg-white text-gray-600 hover:bg-gray-50 font-bold py-2 px-4 rounded-xl shadow-sm transition-colors border border-gray-200">
